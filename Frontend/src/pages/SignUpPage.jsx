...
const SignUpPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 mt-5">
      {/* left side */}
      <div className="flex flex-col justify-center items-center mt-5 p-6 sm:p-12">
        <div className="w-full max-w-md space-y-8">
          {/* LOGO */}
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div
                className="hidden size-12 rounded-xl bg-primary/10 items-center justify-center 
              group-hover:bg-primary/20 transition-colors sm:flex"
              >
